(function(window) {
    ...
    window.ls.view.add({
        ...
        controller: function(element, view, container, form, alerts, expression, window) {
            ...
            let event = expression.parse(element.dataset["event"]);
            let confirm = element.dataset["confirm"] || "";
            let loading = element.dataset["loading"] || "";
            let loaderId = null;
            let scope = element.dataset["scope"] || "sdk";
